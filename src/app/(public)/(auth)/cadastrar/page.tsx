...
import useRegister from '@/hooks/auth/cadastrar/use-register'
...
export default function Cadastrar() {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-6">
      <FormProvider {...form}>
        <form className="w-full max-w-2xl" onSubmit={handleRegister}>
          <Tabs
          ...
          >
            ...
            <div className="space-y-8">
              <TabsList className="grid h-auto w-full grid-cols-2 bg-transparent p-0">
                ...
                <TabsTrigger
                  className="flex items-center justify-start gap-3 data-active:bg-transparent"
                  value="step-1"
                >
                  {currentStep === 'step-1' ? (
                ...
                <TabsTrigger
                  className="flex items-center justify-end gap-3 p-0 data-[state=active]:bg-transparent data-active:bg-transparent"
                  value="step-2"
                >
