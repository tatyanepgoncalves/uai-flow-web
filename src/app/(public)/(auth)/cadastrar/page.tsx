      ...
      >
        ...
        <div className="space-y-8">
          <TabsList className="grid h-auto w-full grid-cols-2 bg-transparent p-0">
            ...
            <TabsTrigger
              className="flex items-center justify-start gap-3 bg-transparent"
              value="step-1"
            >
              {currentStep === 'step-1' ? (
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-violet-600 font-semibold text-white text-xs shadow-[0_0_15px_rgba(124,58,237,0.5)]">
                  01
                </div>
              ) : (
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-tertiary-main">
