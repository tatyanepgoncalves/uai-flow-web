...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      className={cn(
        'font-heading font-medium text-zinc-50 leading-normal group-data-[size=sm]/card:text-sm',
        className
      )}
